...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['file.temporary_storage'] = new \Symfony\Component\HttpFoundation\File\SessionBasedTemporaryStorage($this->get('session'), 'ThisTokenIsNotSoSecretChangeIt', 'C:\\xampp\\htdocs\\sesion\\app/cache/prod/upload');
    }
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('C:\\xampp\\htdocs\\sesion\\app/logs/prod.log', 100, false);
    }
    ...
    {
        return $this->services['translator.real'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => 'php', 'translation.loader.yml' => 'yml', 'translation.loader.xliff' => 'xliff'), array('cache_dir' => 'C:\\xampp\\htdocs\\sesion\\app/cache/prod/translations', 'debug' => false), $this->get('session'));
    }
    protected function getTwigService()
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => false, 'strict_variables' => false, 'cache' => 'C:\\xampp\\htdocs\\sesion\\app/cache/prod/twig', 'charset' => 'UTF-8'));
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, new \Symfony\Component\DependencyInjection\ParameterBag\ParameterBag($this->getDefaultParameters()), 'C:\\xampp\\htdocs\\sesion\\app/../web', false);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => false,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'C:\\xampp\\htdocs\\sesion\\app/cache/prod',
            ...
            'router.resource' => 'C:\\xampp\\htdocs\\sesion\\app/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'C:\\xampp\\htdocs\\sesion\\app/cache/prod/twig',
                'charset' => 'UTF-8',
            ),
            ...
            'doctrine.orm.proxy_dir' => 'C:\\xampp\\htdocs\\sesion\\app/cache/prod/doctrine/orm/Proxies',
            ...
            'assetic.cache_dir' => 'C:\\xampp\\htdocs\\sesion\\app/cache/prod/assetic',
